...
$instagramPassword = "bordeianu"; //PASSWORD
  ...
  try {
    ...
    $followers = $user->getFollowerCount();
      ...
      echo "<div id='y' style='box-shadow: inset 0px 0px 0 2000px rgba(0,0,0,0.5); padding-top:10px; padding-bottom:3px;' class='col-md-12 text-center'>
            <p><img  width='50px;' style='margin-left:auto; margin-right:auto;' class='img-responsive img-circle' src='".$pic."'/> ".$name."  |  <span id='toSum'>".$followers."</span> Followers </p>
            </div>
            <input type='hidden' id='currentFollowersToSum' value='".$followers."'/>";
      }
      catch (Exception $e) {
        echo "
